    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <button onclick="addForm('{{ route('kas.store') }}')" class="btn-with-icon btn-main" data-coreui-toggle="modal" data-coreui-target="#modal-form">
                    <i class="mynaui-plus"></i> Tambah
                </button>
            </div>
            <div class="card-body">
...
<script>
    ...
    $(function () {
        table = $('.table').DataTable({
            ...
            language: {
                ...
                searchPlaceholder: "Cari kas..." // placeholder di dalam box
            }
        });
    ...
    function addForm(url) {
        ...
        $('#modal-form .modal-title').text('Tambah Kas');
        ...
        $.get(url)
            .done((response) => {
                if (response.status === 'success' && response.data) {
                    ...
                    $('#modal-form [name=nominal_setoran]').val(response.data.nominal_setoran);
                } else {
                    $('#modal-form').modal('hide');
                }
            })
